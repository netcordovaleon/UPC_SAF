...
namespace SAF.Web
{
    ...
    public partial class ModeloExtranet : DbContext
    {
        ...
        public virtual ObjectResult<SP_SAF_ACEPTARINVITACION_Result> SP_SAF_ACEPTARINVITACION(Nullable<int> cODINV)
        {
            var cODINVParameter = cODINV.HasValue ?
                new ObjectParameter("CODINV", cODINV) :
                new ObjectParameter("CODINV", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_SAF_ACEPTARINVITACION_Result>("SP_SAF_ACEPTARINVITACION", cODINVParameter);
        }
